...
print('Interface Status', 75*'=', sep='\n')
x = json.dumps(dataa)
y = json.loads(x)
print('DN', 49*' ', 'Description', 11*' ', 'Speed', 5*' ', 'MTU', sep = '')
print(50*'-', ' ', 20*'-', ' ', 2*(6*'-'+' '))
for i in range(3):
    print(y['imdata'][i]["l1PhysIf"]["attributes"]['dn'] ,30*' ', y['imdata'][i]["l1PhysIf"]["attributes"]['speed'],5*' ',
          y['imdata'][i]["l1PhysIf"]["attributes"]['mtu'], sep = '')